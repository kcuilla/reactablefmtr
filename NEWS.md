...
* Conditional colors can now be applied to values in relation to the entire dataset instead of by column by setting `span = TRUE` within `color_scales()` and `color_tiles()`
