...
reactable(data,
          columns = list(
            bill_length_mm = colDef(cell = color_tiles(data, colors = my_color_pal)),
            bill_depth_mm = colDef(cell = color_tiles(data, colors = my_color_pal)),
            flipper_length_mm = colDef(cell = color_tiles(data, colors = my_color_pal))))
```
