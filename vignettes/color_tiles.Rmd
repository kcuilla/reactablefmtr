...
df %>%
  reactable(
    columns = list(
      pop = colDef(
        cell = color_tiles(., number_fmt = scales::label_number(accuracy = 0.1, scale_cut = scales::cut_short_scale()))
      ),
      gdpPercap = colDef(
        cell = color_tiles(., number_fmt = scales::label_comma())
      ),
      lifeExp = colDef(
...
df %>%
  reactable(
    ...
    columns = list(
      pop = colDef(
        cell = color_tiles(., number_fmt = scales::label_number(accuracy = 0.1, scale_cut = scales::cut_short_scale()), colors = viridis::viridis(5))
      ),
      gdpPercap = colDef(
        cell = color_tiles(., number_fmt = scales::label_comma(), colors = RColorBrewer::brewer.pal(7, 'Greens'))
      ),
      lifeExp = colDef(
...
df %>%
  reactable(
    columns = list(
      pop = colDef(
        cell = color_tiles(., number_fmt = scales::label_number(accuracy = 0.1, scale_cut = scales::cut_short_scale()), box_shadow = TRUE)
      ),
      gdpPercap = colDef(
        cell = color_tiles(., number_fmt = scales::label_comma(), box_shadow = TRUE)
      ),
      lifeExp = colDef(
...
df_continents %>%
  reactable(
    ...
    columns = list(
      ...
      pop = colDef(
        cell = color_tiles(., number_fmt = scales::label_number(accuracy = 0.1, cut_scale = scales::cut_short_scale()), color_ref = 'continent_cols')
      ),
      gdpPercap = colDef(
        cell = color_tiles(., number_fmt = scales::label_comma(), color_ref = 'continent_cols')
      ),
      lifeExp = colDef(
