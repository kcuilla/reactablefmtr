...
data %>%
  ...
  reactable(
    .,
    theme = fivethirtyeight(centered = TRUE, header_font_size = 11, font_size = 12),
    pagination = FALSE,
    showSortIcon = FALSE,
    highlight = TRUE,
    compact = TRUE,
    ...
    columns = list(
      Division = colDef(maxWidth = 68,
                        style = group_merge_sort("Division")),
      team_logo_espn = colDef(
        name = "",
        maxWidth = 90,
        sortable = FALSE,
        style = background_img(height = "210%", width = "95%")
      ),
      Team = colDef(
        minWidth = 115,
        align = "left",
        cell = merge_column(., "Record", merged_position = "below", existing_size = 13, spacing = 1),
      ...
      PF = colDef(maxWidth = 200,
                  cell = data_bars(., text_size = 12, box_shadow = TRUE)),
      PA = colDef(maxWidth = 200,
                  cell = data_bars(., text_size = 12, box_shadow = TRUE)),
      MoV = colDef(
        maxWidth = 75,
      ...
      OSRS = colDef(
        maxWidth = 55,
        cell = color_tiles(., bias = 1.3, text_size = 13, box_shadow = TRUE)
      ),
      DSRS = colDef(
        maxWidth = 55,
        cell = color_tiles(., bias = 1.3, text_size = 13, box_shadow = TRUE)
  ...
  add_icon_legend(icon_set = "ski rating", show_labels = TRUE) %>%
