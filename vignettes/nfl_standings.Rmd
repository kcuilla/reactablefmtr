...
data %>%
  ...
  reactable(
    .,
    theme = fivethirtyeight(centered = TRUE, header_font_size = 11, font_size = 11),
    pagination = FALSE,
    showSortIcon = FALSE,
    highlight = TRUE,
    compact = TRUE,
    ...
    columns = list(
      ...
      team_logo_espn = colDef(
        ...
        maxWidth = 65,
        sortable = FALSE,
        style = background_img(height = "210%", width = "110%")
      ),
      Team = colDef(
        minWidth = 105,
        align = "left",
        cell = merge_column(., "Record", merged_position = "below", existing_size = 12, spacing = 1),
