...
reactable(data,
          columns = list(
            body_mass_g = colDef(cell = data_bars_gradient(data, 
                                                           colors = c("white", "pink", "red", "firebrick")))))
```
...
You can also still use `commas = TRUE` to display commas in the values of any column containing values in the thousands or greater.
